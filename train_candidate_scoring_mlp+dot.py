...
def parse_args():
    ...
    parser.add_argument("--output_dir", type=str, default="outputs/re_klue_roberta_base_mlp_dot")
    parser.add_argument("--eval_model_dir", type=str, default="outputs/re_klue_roberta_base_mlp_dot/best_model")
