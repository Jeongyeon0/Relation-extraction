...
#    score = MLP score + bilinear score
# =========================================================
...
def parse_args():
    ...
    parser.add_argument("--output_dir", type=str, default="outputs/re_klue_roberta_base_mlp_bilinear")
    parser.add_argument("--eval_model_dir", type=str, default="outputs/re_klue_roberta_base_mlp_bilinear/best_model")
